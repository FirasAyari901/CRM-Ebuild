                    ...
                    <div class="card">
                      ...
                      <div>
                        <b-form @submit.stop.prevent="add">
                          ...
                          <b-form-group id="example-input-group-7" label="role" label-for="example-input-7">
                            <b-form-select
                              id="example-input-7"
                    ...
                    <div class="card">
                      ...
                      <div>
                        <b-form @submit.stop.prevent="updatee">
                          ...
                          <b-form-group id="example-input-group-2" label="num_tel" label-for="example-input-2">
                            <b-form-input
                              id="num_tel"
                              name="example-input-2"
                              v-model="form.num_tel"
                          ...
                          <b-form-group id="example-input-group-4" label="CV" label-for="example-input-4">
                            <b-form-file
                              id="CV"
                              name="example-input-4"
                              @change="CV"
    ...
    data() {
      return{
        roles: [
          ...
          { value: 'dev back-end', text: 'dev back-end' },
          { value: 'dev front-end', text: 'dev front-end' },
          { value: 'dev fullstack', text: 'dev fullstack' },
          { value: 'dev mobile', text: 'dev mobile' },
          { value: 'designer', text: 'designer' },
          { value: 'community manager', text: 'community manager' }
        ],
        form: {
          num_tel:'',
          CV:'',
    ...
    methods: {
      ...
      add() {
        ...
        this.$validator.validateAll().then(result => {
          ...
          axios.post('personnels',this.form).then(res =>{
            if (res.data.status == 200){
              this.$toastr.s('Staff member added ');
              setTimeout(() => {
                location.reload();
              }, '500');
            } else{
      ...
      updatee() {
        this.$validator.validateAll().then(result => {
          ...
          axios.put('personnels/'+String(this.id),this.form).then(res =>{
            if (res.data.status == 200){
              this.$toastr.s('Staff member updated !');
              setTimeout(() => {
                location.reload();
              }, '500');
            } else{
