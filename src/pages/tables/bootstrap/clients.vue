<template>
    ...
    <b-form @submit.stop.prevent="onSubmit">
      ...
      <b-form-group id="example-input-group-3" label="password" label-for="example-input-3">
       ...
       <b-form-group id="example-input-group-5" label="logo" label-for="example-input-5">
        <b-form-file
          id="example-input-5"
      ...
      <b-form-group id="example-input-group-2" label="raison_sociale" label-for="example-input-2">
        <b-form-select
          id="example-input-2"
    ...
    data(){
      ...
      form: {
        ...
        tablefields: [
          ...
          { key: 'office', label: 'phone number', sortable: true, },
          { key: 'startdate', label: 'date creation', sortable: true, },
          { key: 'salary', label: 'raison sciale', sortable: true, },
          { key: 'age', label: 'etat', sortable: true, },
          { key: 'isons', label: '',  },
        ],
